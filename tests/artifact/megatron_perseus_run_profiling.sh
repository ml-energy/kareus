...
#   bash megatron_perseus_run_profiling.sh <node_rank> <config_name> <CP> <TP> <MBS> <SEQ>
#
...
# Organises timer/energy outputs into profiling/node{0,1}/{freq}/timers/.
# Node 1 SCPs its results back to node 0.  Touches .profiling_complete when done.
