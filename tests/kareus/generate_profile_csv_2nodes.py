...
if __name__ == "__main__":
    ...
    parser.add_argument("--profile_dir", default="nemo_experiments/megatron_qwen3_1p7b/cp2_tp4_bs8_seq8192/profiling", help="Directory containing profiling results.")
