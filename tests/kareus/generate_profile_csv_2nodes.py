...
if __name__ == "__main__":
    ...
    parser.add_argument("--profile_dir", default="nemo_experiments/megatron_llama_3_2_3b/cp2_tp4_bs8_seq4096/profiling", help="Directory containing profiling results.")
