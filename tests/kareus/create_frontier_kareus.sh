...
DEFAULT_PERSEUS_DIR="${SCRIPT_DIR}/${MODEL_NAME}/${CONFIG}/perseus_results4"
...
TARGET_DIR="${PERSEUS_DIR}/../kareus_frontier"
mkdir -p "${TARGET_DIR}"
...
echo "Copying ${#SCHED_FILES[@]} scheds plans to ${TARGET_DIR}"
