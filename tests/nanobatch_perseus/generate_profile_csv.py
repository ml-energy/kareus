...
@dataclass
class Args:
    # Directory containing profiling results (with node0/, node1/ subdirs)
    profile_dir: str
    # Number of microbatches
    num_microbatches: int = 8
    # Number of profiling iterations (after warmup)
    num_prof_iters: int = 20
    # Number of warmup iterations to skip
    warmup_iters: int = 10
    # Number of ranks per pipeline stage (CP * TP)
    num_ranks_per_stage: int = 8
