...
# for each config, calls run_all_freqs.sh to run all frontier freqs plans:
...
for cfg in "${configs[@]}"; do
  results_dir="${SCRIPT_DIR}/${model_name}/${cfg}/frontier"
  ...
  echo "============================================"
  echo "Running all frontier freqs for config: ${cfg}"
