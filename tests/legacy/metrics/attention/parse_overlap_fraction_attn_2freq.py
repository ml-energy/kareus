...
def main():
    ...
    parser.add_argument("--time_threshold", type=float, default=0.0055, help="Measured time threshold for plotting (seconds)")
    parser.add_argument("--no_time_filter2", action="store_true", help="Disable measured time filter for frequency2")
    parser.add_argument("--time_threshold2", type=float, default=0.0065, help="Measured time threshold for plotting for frequency2 (seconds)")
    ...
    if merged1 is not None and frequency2 and merged2 is not None:
        ...
        out_time_overlay = os.path.join(combined_dir, f"attn_overlap_fraction_vs_time__{args.frequency}_vs_{frequency2}.pdf")
        plt.tight_layout()
        ...
        out_energy_overlay = os.path.join(combined_dir, f"attn_overlap_fraction_vs_energy__{args.frequency}_vs_{frequency2}.pdf")
        plt.tight_layout()
