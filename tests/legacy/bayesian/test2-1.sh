cd qkv_ag
CUDA_VISIBLE_DEVICES=0,1 python bo_search_attn.py --batch_size 8 --seq_len 8192 --use_effective_energy --normalize_objectives > bo_search_attn_llama3.2_3b.log 2>&1
CUDA_VISIBLE_DEVICES=0,1 python bo_search_attn_backward.py --batch_size 8 --seq_len 8192 --use_effective_energy --normalize_objectives > bo_search_attn_backward_llama3.2_3b.log 2>&1

CUDA_VISIBLE_DEVICES=0,1 python bo_search_attn.py --batch_size 16 --seq_len 4096 --use_effective_energy --normalize_objectives > bo_search_attn_llama3.2_3b_16_4096.log 2>&1
cd ..
