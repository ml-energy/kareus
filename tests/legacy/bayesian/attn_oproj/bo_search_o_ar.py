...
BO_CONFIG = BOSearchConfig(
    banner="Attention OProj Fuser (O-AR backward)",
    logs_dir_fn=lambda args: f"logs/o_ar/{args.model_name}/cp{args.context_parallel_size}-tp{args.world_size}-bs{args.batch_size}-seq{args.seq_len}",
