...
if __name__ == "__main__":
    ...
    parser.add_argument("--profile_dir", default="nemo_experiments/megatron_qwen3_1p7b/cp1_tp8_bs16_seq4096/profiling", help="Directory containing profiling results.")
    ...
    parser.add_argument("--num_prof_iters", default=10, type=int, help="Number of profiling iterations.")
    parser.add_argument("--warmup_iters", default=5, type=int, help="Number of warmup iterations.")
    parser.add_argument("--gpu_type", default="A100", choices=["A40", "A100"], help="Name of the GPU type.")
    parser.add_argument("--tensor_parallel_size", default=8, type=int, help="Number of tensor-parallel ranks per stage. Times and energies are summed across these ranks.")
