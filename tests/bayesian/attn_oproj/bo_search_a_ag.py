...
BO_CONFIG = BOSearchConfig(
    banner="Attention OProj Fuser (A-AG backward)",
    logs_dir_fn=lambda args: f"logs/a_ag/{args.model_name}/cp{args.context_parallel_size}-tp{args.tensor_parallel_size}-bs{args.batch_size}-seq{args.seq_len}",
