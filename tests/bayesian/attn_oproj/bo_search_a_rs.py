...
BO_CONFIG = BOSearchConfig(
    banner="Attention OProj Fuser (A-RS backward)",
    logs_dir_fn=lambda args: f"logs/a_rs/{args.model_name}/cp{args.context_parallel_size}-tp{args.tensor_parallel_size}-bs{args.batch_size}-seq{args.seq_len}",
