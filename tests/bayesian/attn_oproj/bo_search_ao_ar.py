...
This mirrors the QKV forward optimizer but targets the AO-AR fuser.
"""
...
class PartitionTestConfig:
    """
    Lightweight configuration holder for bo_utils compatibility (AO-AR forward).
    Used only in parent process.
    """
    def __init__(self, args: argparse.Namespace):
        self.args = args
        logs_dir = f"logs/ao_ar/{args.model_name}/cp{args.context_parallel_size}-tp{args.world_size}-bs{args.batch_size}-seq{args.seq_len}"
...
def main() -> None:
    ...
    print("===============================================")
    print("Bayesian Optimization for Attention OProj Fuser (AO-AR forward; real measurements)")
    print("===============================================")
    ...
    for ib in range(int(start_batch_idx), int(args.batches)):
        ...
        print("Evaluating selected candidates on hardware (AO-AR forward)...")
