...
BO_CONFIG = BOSearchConfig(
    banner="QKV-AR Fuser (forward)",
    logs_dir_fn=lambda args: f"logs/{args.model_name}/cp{args.context_parallel_size}-tp{args.world_size}-bs{args.batch_size}-seq{args.seq_len}/forward",
