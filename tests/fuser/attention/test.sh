...
nvidia-smi -i 0,1,2,3 --lock-gpu-clocks=1700,1700
python test_attn_baseline.py --frequency 1700 > output.log 2>&1

nvidia-smi -i 0,1,2,3 --lock-gpu-clocks=1600,1600
python test_attn_baseline.py --frequency 1600 > output.log 2>&1

nvidia-smi -i 0,1,2,3 --lock-gpu-clocks=1500,1500
python test_attn_baseline.py --frequency 1500 > output.log 2>&1

nvidia-smi -i 0,1,2,3 --lock-gpu-clocks=1400,1400
python test_attn_baseline.py --frequency 1400 > output.log 2>&1

nvidia-smi -i 0,1,2,3 --lock-gpu-clocks=1300,1300
python test_attn_baseline.py --frequency 1300 > output.log 2>&1