...
for frequency in 1400 1300 1200 1100 1000; do
    ...
    output_file="output_baseline_bwd_${frequency}.log"
    
    # Run the test
    CUDA_VISIBLE_DEVICES=${GPU1},${GPU2} python -u test_attn_backward_baseline.py --frequency ${frequency} > ${output_file} 2>&1
