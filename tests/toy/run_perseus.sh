#!/usr/bin/env bash
# Toy Perseus test: profiling → CSV → optimization → PFO + training
# for 4 GPUs (1 node), PP=2, TP=2.
#
# Usage:
#   bash run_perseus.sh [config_name]
#
...
echo "===== Toy Perseus 4-GPU Test (GPU_TYPE=${GPU_TYPE}, PP=${PP}, TP=${TP}, #microbatches=${NUM_MICROBATCHES}) ====="
echo "Config: ${CFG}"
echo ""
