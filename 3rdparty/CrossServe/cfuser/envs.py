...
class PackagesEnvChecker:
    ...
    def check_flash_attn(self):
        try:
            ...
            logger.warning(
                f'Flash Attention library "flash_attn" not found, ' f"using pytorch attention implementation"
            )
            return False

    def check_long_ctx_attn(self):
        # NOTE(runyu): actually we don't use yunchang, we extract the yunchang core code and implement our own version
        return True
