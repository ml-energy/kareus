...
@cFuserLayerWrappersRegister.register(PatchEmbed)
class cFuserPatchEmbedWrapper(cFuserLayerBaseWrapper):
    def __init__(
        self,
...
@cFuserLayerWrappersRegister.register(CogVideoXPatchEmbed)
class cFuserCogVideoXPatchEmbedWrapper(cFuserLayerBaseWrapper):
    def __init__(
        self,
    ...
    def forward(self, text_embeds: torch.Tensor, image_embeds: torch.Tensor):
        ...
        """
        sum_height = get_runtime_state().input_config.height // get_runtime_state().vae_scale_factor_spatial
        ...
        if self.use_positional_embeddings or self.use_learned_positional_embeddings:
            ...
            pos_embed_list = [
                pos_embedding[
                    ...
                    + get_runtime_state().pp_patches_token_start_end_idx_global[0][0] : post_patch_height
                    * post_patch_width
                    * i
