...
# rm -rf log/benchmark/component_scaling_efficiency/comm_scaling_efficiency/comm_scaling_efficiency.json
    ...
    for seq_len in "${seq_len_list[@]}"; do
        for mlp_world_size in "${mlp_world_size_list[@]}"; do
            ...
            for attn_world_size in "${attn_world_sizes[@]}"; do
                ...
                CUDA_VISIBLE_DEVICES=$visible_devices run_test python benchmark/component_scaling_efficiency/comm_scaling_efficiency/test_ulysses_ring.py \
