...
LOG_DIR = "log"
with open(
    f"{LOG_DIR}/benchmark/component_scaling_efficiency/ulysses_scaling_efficiency/ulysses_scaling_efficiency.json", "r"
) as f:
    data = json.load(f)
...
plt.tight_layout()
plt.savefig(f"{LOG_DIR}/benchmark/component_scaling_efficiency/ulysses_scaling_efficiency/scaling_efficiency.png")
plt.close()
