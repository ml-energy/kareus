...
bash run_profiling0.sh
bash run_profiling1.sh
python profile_p2p.py
python generate_profile_csv_2nodes.py
...
# enable_perseus_optimizer: true
# ZEUS_PFO_SCHEDULER=PointSolution3D ZEUS_PFO_SCHEDULER_ARGS='{"solution_path": "/workspaces/Kareus/tests/kareus/llama3.2_3b/cp2_tp4_bs16_seq4096/freqs_pipeline_07795.py"}' uvicorn zeus.optimizer.pipeline_frequency.server.router:app --port 7787
