...
class _AttentionFuserAutogradFunction(torch.autograd.Function):
    ...
    def forward(
        ...
        allreduce_comm_op_fwd: Optional[FusibleOperation],
        allreduce_comm_op_bwd: Optional[FusibleOperation],
        ...
        *params_and_extra_inputs: torch.Tensor
        ...
        if ar_start == -1 and allreduce_comm_op_fwd is not None:
            allreduce_output = allreduce_comm_op_fwd.fuser_forward(
            ...
            allreduce_comm_op_fwd.sync()
        
        if ar_start == 0:
            allreduce_comm_op_fwd.event_record(current_stream)
        ...
        for fused_idx, (op, basic_op_idxs) in enumerate(forward_ops):
            ...
            if ar_start == fused_idx:
                ...
                allreduce_comm_op_fwd.event_wait()
                allreduce_output = allreduce_comm_op_fwd.fuser_forward(
                    [None], allreduce_input,
                    basic_op_extra_inputs=[], basic_op_prev_ops=[None], basic_op_next_ops=[None], basic_op_kwargs=[{"sm_num": sm_num, "block_size": block_size}]
                )
        ...
        if is_grad_enabled:
            ...
            func_ctx.allreduce_comm_op_bwd = allreduce_comm_op_bwd
        ...
        return x, bias, residual, allreduce_output
    ...
    def backward(
        ...
        allreduce_comm_op_bwd = func_ctx.allreduce_comm_op_bwd
        ...
        if ar_start == -1 and allreduce_comm_op_bwd is not None:
            allreduce_comm_op_bwd.fuser_forward(
                [None], grad_allreduce_input,
                basic_op_extra_inputs=[], basic_op_prev_ops=[None], basic_op_next_ops=[None], basic_op_kwargs=[{"sm_num": sm_num, "block_size": block_size}]
            )
            allreduce_comm_op_bwd.sync()
    
        if ar_start == 0:
            allreduce_comm_op_bwd.event_record(current_stream)
        ...
        for fused_idx, (op, basic_op_idxs) in enumerate(backward_ops):
            ...
            if ar_start == fused_idx:
                allreduce_comm_op_bwd.event_wait()
                allreduce_comm_op_bwd.fuser_forward(
                    [None], grad_allreduce_input,
                    basic_op_extra_inputs=[], basic_op_prev_ops=[None], basic_op_next_ops=[None], basic_op_kwargs=[{"sm_num": sm_num, "block_size": block_size}]
                )
        ...
        return (
            ...
            None,  # allreduce_comm_op_fwd
            None,  # allreduce_comm_op_bwd
            None,  # forward_ops
            None,  # backward_ops
            None,  # basic_ops
...
class AttentionFuser:
    ...
    def __init__(
        ...
        allreduce_comm_op_fwd: Optional[FusibleOperation] = None,
        allreduce_comm_op_bwd: Optional[FusibleOperation] = None,
        fuse_ops: bool = True,   
    ) -> None:
        ...
        self._allreduce_comm_op_fwd = allreduce_comm_op_fwd
        self._allreduce_comm_op_bwd = allreduce_comm_op_bwd
    ...
    def __call__(
        ...
        args += (
            ...
            self._allreduce_comm_op_fwd,
            self._allreduce_comm_op_bwd,
            self._forward_ops,
            self._backward_ops,
            self._basic_ops,
            is_grad_enabled,
